...
def preprocess():
    ...
    #class_weight_dict = {0: 1243.5, 1: 191.3077, 2: 20.725, 3: 12.435, 4: 16.58, 5: 1.2435, 6: 1243.5}
...
class model:
    ...
    def test(self, x_test, y_test):
        ...
        plt.title("Conventional LSTM", fontsize=16) 
        #plt.savefig('tradition LSTM_Multi-class Classification.svg', format='svg', dpi=300) 
        plt.show()
...
if __name__ == '__main__':
    ...
    #X_train, X_test, y_train, y_test, class_names, class_weight_dict = preprocess()
    X_train, X_test, y_train, y_test, class_names= preprocess()

    #args.class_weight = class_weight_dict
